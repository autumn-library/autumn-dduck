...
DDNS: # Имя настроек, должно быть точно таким же
  ...
  ACMEtxt: # Текст, генерируемый в certbot при создании сертификатов для SSL для ACME CHALLENGE
```
...
* Создание docker compose в связке с обратным прокси на ngnix для получения https запросов
