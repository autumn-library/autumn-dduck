...
DDNS: # Имя настроек, должно быть точно таким же
  ...
  Verbose: # True (Именно на английском), если хотите в логах видеть расширенную информацию по обновлению IP адреса (False (и тут тоже только на английском) по умолчанию)
```
