...
&Деталька(Значение = "DDNS.Verbose", ЗначениеПоУмолчанию = Ложь) 
...
Процедура УстановитьПараметрыАдреса() Экспорт 
	URL = СтрШаблон("https://www.duckdns.org/update?domains=%1&token=%2verbose=%3", Домен, Токен, РасширеннаяИнформация);
